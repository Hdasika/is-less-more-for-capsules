...
parser.add_argument('--model_series', metavar='model', type=int, required=True, choices=[1,2], help='Choose model series')
...
if args.model_series == 1:
	dataset, gen, model = utils.prepare_for_trial_model_one(args)
elif args.model_series == 2:
	dataset, gen, model = utils.prepare_for_trial_model_two(args)
